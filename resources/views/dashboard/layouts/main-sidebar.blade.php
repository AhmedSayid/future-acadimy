...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ route('platform.index') }}"><img
                src="{{asset('assets/img/media/focus_academy.svg')}}" class="main-logo" alt="logo"></a>
    </div>
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround" src="{{ Storage::url(Auth::user()->image) }}"><span
        ...
        <ul class="side-menu">
            ...
            <li class="side-item side-item-category">Focus Academy</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('platform.index') }}">
            ...
            @if(Auth::user()->role == \App\Enums\RoleType::ADMIN)
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('teachers.index') }}">
                        ...
                        <span class="side-menu__label">المدرسين</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('errors.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none"/>
                        ...
                        <span class="side-menu__label">المشاكل البرمجية</span></a>
                </li>
{{--                <li class="slide">--}}
...
{{--                            </g>--}}
{{--                        </svg>--}}
{{--                        <span class="side-menu__label">المواد الدراسية</span></a>--}}
{{--                </li>--}}
{{--                <li class="slide">--}}
{{--                    <a class="side-menu__item" href="{{ url('/' . $page='index') }}">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">--}}
...
{{--                </li>--}}
            @elseif(Auth::user()->role == \App\Enums\RoleType::TEACHER)
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('grades.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none"/>
                            <path
                        ...
                        <span class="side-menu__label">الصفوف الدراسية</span></a>
                </li>
                <li class="slide">
