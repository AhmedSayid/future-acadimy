        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الكورسات</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ إضافة فيديو</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">إضافة فيديو</h4>
            ...
            $('#video').on('change', function (e) {
                ...
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        if (xhr.status === 413) {
                            $('#uploadError').text('Uploaded file is too large. Please upload a smaller file.').show();
                        } else {
